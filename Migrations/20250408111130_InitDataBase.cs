    ...
    public partial class InitDataBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Number = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LocalityId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactDetails_Country_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Country",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactDetails_Locality_LocalityId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Name = table.Column<string>(type: "longtext", nullable: false, defaultValue: "CUSTOMER")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CompanyId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.ComputedColumn),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BursDateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskUsers_User_UsersId",
                        column: x => x.UsersId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersContactDetails_User_UsersId",
                        column: x => x.UsersId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Absent_AcceptedById",
                table: "Absent",
                column: "AcceptedById");

            migrationBuilder.CreateIndex(
                name: "IX_Absent_CompanyId",
                table: "Absent",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Absent_CreatedById",
                table: "Absent",
                column: "CreatedById",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactDetails_LocalityId",
                table: "ContactDetails",
                column: "LocalityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersContactDetails_UsersId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Absent_User_AcceptedById",
                table: "Absent",
                column: "AcceptedById",
                principalTable: "User",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Absent_User_CreatedById",
                table: "Absent",
                column: "CreatedById",
                principalTable: "User",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CompanyUsers_User_UsersId",
                table: "CompanyUsers",
                column: "UsersId",
                principalTable: "User",
                principalColumn: "Id",
